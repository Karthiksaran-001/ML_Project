...
from MlProject.config.configuration import PREPROCESING_OBJ_FILE,TRANSFORM_TRAIn_FILE_PATH,TRANSFORM_TEST_FILE_PATH,FEATURE_ENGG_OBJ_FILE_PATH
...
class Feature_Engineering(BaseEstimator, TransformerMixin):
    ...
    def distance_numpy(self, df, lat1, lon1,lat2, lon2 ):
        logging.info("\t\t\t Calculated Distance Based on Latitude and Longitude \n")
        p = np.pi/180
